...
`-Xms3G -Xmx3G -Dfile.encoding=UTF-8 -Dowo.handshake.disable=true -XX:+UseG1GC -XX:+DisableExplicitGC`
...
`-Xms3G -Xmx3G -Dfile.encoding=UTF-8 -Dowo.handshake.disable=true -XX:+UnlockExperimentalVMOptions -XX:+DisableExplicitGC -XX:+UseZGC -XX:-ZUncommit`
...
`-Xms3G -Xmx3G -Dfile.encoding=UTF-8 -Dowo.handshake.disable=true -XX:+UnlockExperimentalVMOptions -XX:+UseShenandoahGC`
...
[FroggeMC's ZGC repository](https://github.com/cyberpwnn/MC-Java-Flags/blob/c8b2d7ad633768d85f4a92fe01340f8d52081251/README.md),
