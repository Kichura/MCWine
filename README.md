...
It is recommended that you use [one of these specific scripts](https://github.com/Kichura/MCWine/tree/Nightly/sources/jvm_arguments.md) as your JVM arguments instead of the defaults.
