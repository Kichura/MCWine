...
`-Xms3G -Xmx3G -Dfile.encoding=UTF-8 -Dowo.handshake.disable=true -Dsodium.checks.issue2561=false -XX:+DisableExplicitGC -XX:+AlwaysPreTouch -XX:+UseG1GC --add-modules=jdk.incubator.vector`
